      ...
      >
        ...
        <span class="flex min-w-0 flex-1 flex-col">
          ...
          <input
            ...
            type="date"
            :min="today"
            class="mt-0.5 h-6 w-full cursor-pointer appearance-none border-none bg-transparent p-0 text-[16px] focus:outline-none md:text-sm [&::-webkit-calendar-picker-indicator]:hidden [&::-webkit-date-and-time-value]:text-left"
