...
<template>
  <div class="mx-auto max-w-6xl px-4 pb-20 pt-10 sm:px-6 md:pt-14">
    <div class="grid gap-10 md:grid-cols-[1fr_1.3fr] md:gap-16">
      <div>
        <h1 class="text-[26px] font-semibold tracking-tight text-ink md:text-3xl">Hubungi kami</h1>
        <p class="mt-3 max-w-md text-[15px] leading-relaxed text-body">
          Paling cepat lewat WhatsApp. Admin biasanya membalas dalam hitungan
          menit di jam operasional. Telepon juga boleh.
        </p>

        <ul class="mt-8 space-y-5 text-[15px] text-body">
          ...
          <li class="flex items-start gap-3.5">
            ...
            <span>
              ...
              <span class="text-sm text-muted">Check-in {{ settings.check_in_time }} · Check-out {{ settings.check_out_time }}</span>
            </span>
          </li>
          <li class="flex items-start gap-3.5">
      ...
      <iframe
        ...
        class="aspect-[4/3] w-full rounded-md border border-hairline md:aspect-auto md:min-h-[480px]"
        loading="lazy"
        allowfullscreen
